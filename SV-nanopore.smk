...
rule minimap2:
    input:
        ...
        expand("minimap2/{caller}_combined/annot_genotypes.vcf", caller=["sniffles", "nanosv", "svim"]),
...
rule ngmlr:
    input:
        ...
        expand("ngmlr/{caller}_combined/annot_genotypes.vcf", caller=["sniffles", "nanosv", "svim"]),
